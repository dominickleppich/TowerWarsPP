...
Im Falle eines Netzwerkspiels wird über die Einstellung \code{-networktype} gesteuert ob ein Spieler im Netzwerk angeboten werden oder ein Spieler aus dem Netzwerk gefunden und mit diesem gespielt werden soll.
